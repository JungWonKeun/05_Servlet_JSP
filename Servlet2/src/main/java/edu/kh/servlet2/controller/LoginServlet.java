...
// 해당클래스를 Servlet으로 등록 + "/login" 요청 주소 처리하도록 매핑(연결)
@WebServlet("/login")
public class LoginServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(inputId.equals("user01") 
			...
			&& check.equals("pneumonoultrascopicsilicovolcanoconiosis")) {
			...
			if(!inputPw.equals("pass01!")) {
				result += "<h3>Password가 일치하지 않습니다</h3>";
			}
			
			if(!check.equals("pneumonoultrascopicsilicovolcanoconiosis")) {
				result += "<h3>사람이 아닙니다"
						+ "\r\n"
						+ "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n"
						+ "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⠄⡒⠒⠤⢄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n"
